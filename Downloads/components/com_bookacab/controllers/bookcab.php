 ...
 * @since  1.6
 */
class BookacabControllerBookcab extends BookacabController
{
	/**
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Bookcab', 'BookacabModel');
	...
	public function publish()
	{
		...
		if ($user->authorise('core.edit', 'com_bookacab') || $user->authorise('core.edit.state', 'com_bookacab'))
		{
			$model = $this->getModel('Bookcab', 'BookacabModel');
			...
			if (!$item)
			{
				...
				$this->setRedirect(JRoute::_('index.php?option=com_bookacab&view=bookcabs', false));
			}
			else
			{
	...
	public function remove()
	{
		...
		if ($user->authorise('core.delete', 'com_bookacab'))
		{
			$model = $this->getModel('Bookcab', 'BookacabModel');

 ...
 * @since  1.6
 */
class BookacabControllerPostcab extends JControllerLegacy
{
	/**
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Postcab', 'BookacabModel');
	...
	public function publish()
	{
		...
		if ($user->authorise('core.edit', 'com_bookacab') || $user->authorise('core.edit.state', 'com_bookacab'))
		{
			...
			if (!$item)
			{
				...
				$this->setRedirect(JRoute::_('index.php?option=com_bookacab&view=postcabs', false));
			}
			else
			{

						...
						<div class="form-group date1">
							<div class="date_time">
								<div class="cabme_date">
									<input type="text" placeholder="DD/MM/YY" id="cabme_date" name="filter[cabme_date]">
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="date_time">
								<div class="cabme_time">
									<input type="text"  placeholder="Select Time Format" id="cabme_time" name="filter[cabme_time]">
								</div>
							</div>
						</div>
						<div class="form-group search_datetime">
						  <input type="submit" value="FIND NOW"/>
						</div>
						<div class="cabme_border"></div>
					</form>
					<form class="form-horizontal filter_form" role="form">
						<div class="form-group p"><p id="price">PRICE</p></div>
						<div class="price_range">
				        	<div class="min_max">
         						<div class="pramnts"><input class="priceCompare" name="minamt" type="text" id="min-budget"></div>
		 						<div class="pramnts"><input class="priceCompare" name="maxamt" type="text" id="max-budget"></div>
      						</div>
      						<div id="slider-3"></div>
						</div>
						...
						<div class="form-group cab_refin">
							<a href="#" class="cab_refine">REFINE NOW</a>
						</div>
						<!-- /.container-fluid -->
					</form>
				</div>

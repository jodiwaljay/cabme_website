...
define("AUTARTICAPTCHA_LENGTH",4);
...
class AutarticaptchaHelper
{
	...
	{
		return "<input type=\"text\" class=\"inputbox required text_area\" id=\"autarticaptcha_entry\" name=\"autarticaptcha_entry\" value=\"\" maxlength=\"4\" size=\"5\"/>";
	}

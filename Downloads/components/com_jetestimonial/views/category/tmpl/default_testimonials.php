							...
							<div id="style<?php echo $this->settings->theme;?>-inner3">
								...
								<?php
									if($this->settings->theme == '6' || $this->settings->theme == '3'):?>
										...
										<?php } ?>
										<?php if($value->lvideo != '' && $this->params->get('show_video', 1)){ ?>
											<a rel='{handler: "iframe",size:{x:560,y:365}}'  id="style6play" class="modal" href="<?php echo $path; ?>index.php?option=com_jetestimonial&view=testimonials&layout=default_video&tmpl=component&id=<?php echo $value->id;?>&lvideo=1"><img src="<?php echo $path ; ?>/components/com_jetestimonial/assets/images/sunshine-btn.png" alt="no" id="buttonimg"/></a>
										<?php } ?>
										<?php if($value->laudio != '' && $this->params->get('show_audio', 1)){ ?>

	...
	<table class="table table-striped" id="mediadetailList">
		...
		<?php foreach ($this->items as $i => $item) : ?>
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<img src="<?php echo JURI::root().$item->publication_image; ?>" alt="<?php echo $this->escape($item->publication_name); ?>" title="<?php echo $this->escape($item->publication_name); ?>"/>
					
				</td>
				<td>

					<a href="<?php echo $item->link; ?>"><?php echo $item->headline; ?></a>
				</td>

...
<div id="btl">
	...
	<div class="btl-panel">
		...
		<?php else : ?>
			...
			?>
			<span id="btl-panel-login" class="<?php echo $effect;?>"><?php echo "Sign In";?></span>
			<?php }?>
			<!-- Registration button -->
			<?php
	...
	<div id="btl-content">
		...
		<div id="btl-content-login" class="btl-content-block">
			...
			<form name="btl-formlogin" class="btl-formlogin" action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post">
				...
				<button type="button" class="modalCloseImg simpleModalCloseImg simplemodal-close close" data-dismiss="btl-content-login"></button>	
				<h3> <span class="sign">SIGN IN </span> <span class="now">NOW..!!</span></h3>
				<br>

				
				<div class="btl-error" id="btl-login-error"></div>
				<div class="btl-field line">
					
					<div class="btl-input line">
						<input id="btl-input-username" type="text" name="username" placeholder="Email Id" />
					</div> 
				</div>
				<div class="btl-field ">
					<div class="btl-label glyphicon glyphicon-lock"><?php echo JText::_('') ?></div>
					<div class="btl-input ">
				...
				<?php endif; ?>
				<div class="btl-buttonsubmit">
					<input type="submit" name="Submit" class="btl-buttonsubmit second_class" onclick="return loginAjax()" value="<?php echo JText::_('SIGN IN NOW') ?>" /> 
					...
					<div id="register-link" >
						<?php echo sprintf(JText::_('DONT_HAVE_AN_ACCOUNT_YET'),'<a href="'.JRoute::_('').'">','</a>');?>
					</div>
				<?php else: ?>
			...
			<ul id ="bt_ul" class="f">
              ...
              <div class="or">
               ...
               <div class="follow-us">
                   ...
                   <ul class="social">
                      <li><a href="#"><img src="images/gs/facebook.jpg" alt="Facebook" /></a></li>
                      <li><a href="#"><img src="images/gs/gplus.jpg" alt="Google plus" /></a></li>
                      <li><a href="#"><img src="images/gs/twitter.jpg" alt="Twitter" /></a></li>
                      <li><a href="#"><img src="images/gs/linkdin.jpg" alt="Linkdin" /></a></li>
                   </ul>
                </div>
		...
		<div id="btl-content-registration" class="btl-content-block">			
			...
			<?php if($integrated_com==''){?>	
				...
				<form name="btl-formregistration" class="btl-formregistration"  autocomplete="off">
					...
					<div class="btl-buttonsubmit">						
						<button type="submit" class="btl-buttonsubmit second_class" onclick="return registerAjax()" >

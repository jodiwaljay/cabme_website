...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'cabtype.cancel') {
			Joomla.submitform(task, document.getElementById('cabtype-form'));
		}
		else {
			
			if (task != 'cabtype.cancel' && document.formvalidator.isValid(document.id('cabtype-form'))) {
...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="cabtype-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_BOOKACAB_TITLE_CABTYPE', true)); ?>
		<div class="row-fluid">

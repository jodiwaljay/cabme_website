...
$canOrder  = $user->authorise('core.edit.state', 'com_media_details');
$saveOrder = $listOrder == 'a.`ordering`';

if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_media_details&task=mediadetails.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'mediadetailList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_media_details&view=mediadetails'); ?>" method="post"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<h2 class="jobhdng"> Press Release </h2>
			<table class="table table-striped" id="mediadetailList">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
	<?php echo JHtml::_('jgrid.published', $item->state, $i, 'mediadetails.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_media_details&task=mediadetail.edit&id='.(int) $item->id); ?>">
					<?php echo $this->escape($item->publication_name); ?></a>
				<?php else : ?>
					<?php echo $this->escape($item->publication_name); ?>
				<?php endif; ?>
				</td>
				<td><?php echo $item->publication_image; ?></td>

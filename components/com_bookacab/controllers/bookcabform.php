...
class BookacabControllerBookcabForm extends JControllerForm
{
	...
	public function save()
	{
		...
		//SMS Function Starts (book a cab popup->no)
		if ($return)
		{
	...
	/* Method to send SMS for Users (Registered user book a cab-> no)  */
	...
	/* Method to send SMS for Driver (Driver user book a cab-> no) */

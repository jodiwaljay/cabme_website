	    ...
	    <nav class="collapse navbar-collapse" role="navigation">
	      <div class="nav navbar-nav search_cabme" id="nav-list">
	      	  <form id="searchridelist" action="<?php echo JRoute::_('index.php?option=com_bookacab&task=postcabs'); ?>" method="post" enctype="multipart/form-data">
			      <div class="loc-map cab_from"><label>From:</label><input name="filter[source]" class="placepicker" id="icon" type="text" value=" <?php echo $source ?> " /></div>
			      <div class="cab_refresh"><p href="#" id="dir-image"  class="direction"><img src="<?php echo JURI::base(); ?>/images/header-icon.jpg"></p></div>
			      <div class="cab_from"><label>To:</label><input name="filter[destination]" class="placepicker" id="icon1" type="text" value=" <?php echo $destination ?> " /></div>
		...
		<div class="row results_list">
	        ...
	        <div class="col-sm-2 third-row">
	            ...
	            <div class="join_cab">
					...
					?>
					<a href="<?php echo JRoute::_('index.php?option=com_bookacab&view=bookcab&layout=popup&id='.$item->id.'&tmpl=component'); ?>" rel="{size: {x: 450, y: 400}, closable: true}" class="modal">Join Now</a>
					...
					<input type="hidden" class="drfrom" value="<?php echo $item->from;  ?>" />
					<input type="hidden" class="drto" value="<?php echo $item->to;  ?>" />
					<input type="hidden" class="drseats" value="<?php echo $item->no_of_seats;  ?>" />

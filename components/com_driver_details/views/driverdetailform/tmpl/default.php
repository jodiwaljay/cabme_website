...
<div class="driverdetail-edit front-end-edit">
		...
		<div class="row bcomdriver">
			<div class="col-md-6">
				...
				<div class="control-group">
					...
					<div class="colonlabels">:</div>
					<div class="controls gender"><?php echo $this->form->getInput('dgen'); ?></div>
				</div>
				...
				<div class="text-center smoking">
					<label class="radio-inline">
		 				 <input class="nosmoke" type="radio" name="optradio" value="" checked="checked" >No Smoking
					</label>
				    <label class="radio-inline">
			...
			<div class="col-md-6">
				<div class="cab_group">
					...
					<div class="control-group">
						<div class="control-label"><label id="jform_cab_no-lbl" class="" for="jform_cab_no"> Cab No</label></div>
						<div class="colonlabels">:</div>
						<div class="controls"><input id="jform_cab_no" class="inputbox" type="text" size="40" value="" name="jform[cab_no][]"></div>
					</div>
					<div class="control-group">
						<div class="control-label"><label for="cabtype">Cab Type</label></div>
						<div class="colonlabels">:</div>
						<div class="controls">
	                         <select class="driver_cabtype" name="jform[cab_type][]" id="cab_type"><option value="">Choose Cab Type</option>
								 <?php
					...
					<div class="control-group">
						<div class="control-label"><label id="jform_price_per_km-lbl" class="" for="jform_price_per_km" aria-invalid="false"> Price Per Km</label></div>
						<div class="colonlabels">:</div>
						<div class="controls"><input id="jform_price_per_km" class="inputbox" type="text" size="40" value="" name="jform[price_per_km][]"></div>
					</div>
				</div>
	...
	<div class="control-group text-center">
		<div class="controls drivesubmit">
			<?php if ($this->canSave): ?>
			    <input type="hidden" value="0" name="jform[arrcount]" id="arrcount" />
...
<script>
	jQuery(document).ready(function(){
		<!-- Become a driver form validation  -->
		...
		messages: {
		  'jform[dname]': "Enter your name",
		  'jform[demail]': "Enter your email id",
		...
		<!-- Become a driver form validation ends  -->

		<!-- Add more Cab Details  -->
		var counter = 1;
	    jQuery("#addcab").live("click",function(){
           var cfcount=parseInt(jQuery("#arrcount").val());
		   var totfcount=parseInt(cfcount+1);
		   jQuery("#arrcount").val(totfcount);
	       var newCab = jQuery("<div class='cab_group'>");
			...
			rows += '<div class="control-group"><div class="control-label"><label id="jform_cab_type-lbl" class="" for="jform_cab_type" aria-invalid="false"> Cab Type</label></div><div class="colonlabels">:</div><div class="controls"><div class="cabtypeInner"><select class="driver_cabtype" name="jform[cab_type][]" id="cab_type"><option value="">Choose Cab Type</option><?php foreach($cabtypes as $res){?><option value="<?php echo $res->cab_type;  ?>"><?php echo $res->cab_type;  ?></option><?php } ?></select></div></div></div>';
	        ...
	        newCab.append(rows);
	        if (counter == 10) jQuery('#addcab').attr('disabled', true).prop('value', "Done");

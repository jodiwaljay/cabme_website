...
<script type="text/javascript">
	...
	jQuery(document).ready(function(){
		<!--book now sms function yes or no -->
			...
			if(pick=="Yes")
			{
            	...
            	jQuery.ajax
				 ({
				   ...
				   {
				   	  //alert(data);
				      alert("Thankyou for booking a Cab. Soon will receive a confirmation message. Please Submit the Post a Cab Form");
		...
		jQuery("#searchridehome").validate({
	       	...
	       	submitHandler: function(form) {
		    	...
		    	if(userid=='0' && window.checkLogin == true)
		    	{
		    		dshowLoginForm(jQuery("#homesearchsubmit"));
		    		return false;
		    	}
		    	else
		    	{
		...
		jQuery("#form-postcab").validate({
	       	...
	       	submitHandler: function(form) {
		    	...
		    	if(userid=='0' && window.checkLogin == true)
		    	{
		    		dshowLoginForm(jQuery("#postcabsubmit"));
		    		return false;
		    	} else {
		    		form.submit();
		    	}
		...
		jQuery(".bookCab a").click(function(){

			if(jQuery("#formbookcab").valid()){
				var userid="<?php echo $userid; ?>";
		    	if(userid=='0' && window.checkLogin == true)
		    	{
		    		dshowLoginForm(jQuery(".bookCab a"));
		    		return false;
		    	}

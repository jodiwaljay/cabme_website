 ...
 * @since		1.5
 */
class JEPagination extends JObject
{
	/**
...
//		$list['limitfield']		= $this->getLimitBox();
	...
	protected function _buildDataObject()
	{
		...
		$data->all = new JEPaginationObject(JText::_('JLIB_HTML_VIEW_ALL'), $this->prefix);
		if (!$this->_viewall) {
			$data->all->base	= '0';
		...
		$data->start	= new JEPaginationObject(JText::_('JLIB_HTML_START'), $this->prefix);
		$data->previous	= new JEPaginationObject(JText::_('JPREV'), $this->prefix);
		...
		$data->next	= new JEPaginationObject(JText::_('JNEXT'), $this->prefix);
		$data->end	= new JEPaginationObject(JText::_('JLIB_HTML_END'), $this->prefix);
		...
		for ($i = $this->get('pages.start'); $i <= $stop; $i ++)
		{
			...
			$data->pages[$i] = new JEPaginationObject($i, $this->prefix);
 ...
 * @since		1.5
 */
class JEPaginationObject extends JObject
{
	public $text;
	public $base;
	public $link;
